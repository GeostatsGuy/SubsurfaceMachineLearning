...
You will gain:
* knowledge concerning data analytics and machine learning for subsurface modeling.

#### Course Agenda
* Introduction: objectives, plan
* Data analytics - definitions, bootstrap, confidence intervals and hypothesis testing
* Inference – multivariate analysis, feature selection and principal component analysis
* Prediction - simple model demonstration of prediction concepts, decision tree
* Advanced Prediction – support vector machines, neural nets (artifical, convolutional and recurrent)
* Conclusions
